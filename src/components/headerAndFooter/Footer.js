...
export default function Footer() {
  return (
    <div style={{ fontSize: ".75rem"}} className="navbar bg-dark text-white-50 fixed-bottom">
      ...
      <div><a className="text-white" href="www.oscarchavez.com">www.OscarChavez.com</a></div>
    </div>
  )
}
